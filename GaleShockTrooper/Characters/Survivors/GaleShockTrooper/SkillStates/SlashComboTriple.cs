using GaleShockTrooper.Modules.BaseStates;
using RoR2.Skills;
using RoR2;
using UnityEngine;
...
namespace GaleShockTrooper.Survivors.GaleShockTrooper.SkillStates
{
    /// <summary>
    /// This is an example of a melee attack that uses a SteppedSkillDef to have different behavior.
    /// <see cref="GaleShockTrooperSurvivor.AddPrimarySkills"/> is where we create the skill as a SteppedSkillDef. Without going into too much detail, when you set up the SkillDef like this, that will run some code we can use here as explained below.
